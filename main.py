    ...
    while True:
        ...
        if results:
            for i in results:
                ...
                label4 = Label(f2, text="                            Driver Drowsiness Detection System", font=("arial", 10, "bold"), bg="grey16",
                               fg="white")
                label4.pack(side=BOTTOM, fill=X)
                statusbar = Label(f1, text="                            Driver Drowsiness Detection System", font=("arial", 8, "bold"),
                ...
                label4 = Label(f3, text="                            Driver Drowsiness Detection System", font=("arial", 10, "bold"), bg="grey16",
                               fg="white")
                label4.pack(side=BOTTOM, fill=X)

                # =========================Main Buttons=========================================

                btn2w2 = ttk.Button(f1, text="Detect Drowsiness", command=run_main)
                ...
                label11 = Label(f4, text="     Driver Drowsiness Detection System", font=("arial", 10, "bold"), bg="grey16",
                                fg="white")
                ...
                def swap4(frame):
                    frame.tkraise()
                    statusbar['text'] = '                            Driver Drowsiness Detection System'
