def run_main():
    ...
    model = load_model(r'C:\Users\VISHU_PERI\Desktop\VISHU\KLH_2nd_Year\2nd_Sem\PFSD\PFSD_PROJECT\Model\model.h5')

    mixer.init()
    sound = mixer.Sound(r'C:\Users\VISHU_PERI\Desktop\VISHU\KLH_2nd_Year\2nd_Sem\PFSD\PFSD_PROJECT\alarm.wav')
